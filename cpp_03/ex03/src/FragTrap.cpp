...
/*   Updated: 2024/10/01 16:38:32 by matle-br         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
FragTrap::FragTrap(std::string name): ClapTrap(name), _High_Fives(false)
{
	...
	// std::cout << "Frag Hit_points = " << this->_Hit_points << std::endl;
	// std::cout << "Frag Energy_points = " << this->_Energy_points << std::endl;
	// std::cout << "Frag attack_damages = " << this->_Attack_points << std::endl;
	return ;
}
