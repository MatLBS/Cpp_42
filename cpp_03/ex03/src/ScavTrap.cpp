...
ScavTrap::ScavTrap(std::string name): ClapTrap(name), _gateKeeper(false)
{
	...
	// std::cout << "Scav Hit_points = " << this->_Hit_points << std::endl;
	// std::cout << "Scav Energy_points = " << this->_Energy_points << std::endl;
	// std::cout << "Scav attack_damages = " << this->_Attack_points << std::endl;
	return ;
}
